                ...
                {[
                  {
                    subject: 'He',
                    verb: 'works',
                    complement: 'on Tuesdays',
                    audio: pg106_audio2,
                    translation: 'Ele trabalha às terças-feiras',
                    tradAudio: pg106_trad2,
                  },
                  {
                    subject: 'She',
                    verb: 'works',
                    complement: 'on Wednesdays',
                    audio: pg106_audio3,
                    translation: 'Ela trabalha às quartas-feiras',
                    tradAudio: pg106_trad3,
                  },
                ].map((row, index) => (
                  <tr key={index}>
