...
import audio1 from '../assets/audios/pg266_audio1e.mp3';
import audio2 from '../assets/audios/pg266_audio2e.mp3';
import audio3 from '../assets/audios/pg266_audio3e.mp3';
import audio4 from '../assets/audios/pg266_audio4e.mp3';
          ...
          <main className={styles.page266__mainContent}>
            ...
            <div className={styles.page266__comparisonBlock}>
              ...
              <div className={styles.page266__exampleBox}>
                <p>
                  • Maria is <span className={styles.page266__translation}>as <span className={styles.page266__sublinhar}>tall</span> as</span> Pedro.
                  <img
                    src={eng_audio_icon}
                    alt="Play: Maria is as tall as Pedro."
                    className={styles.page266__icon}
            ...
            <div className={styles.page266__comparisonBlock}>
              ...
              <div className={styles.page266__exampleBox}>
                <p>
                  • João is tall<span className={styles.page266__translation}>er than</span> Maria and Pedro.
                  <img
                    src={eng_audio_icon}
                    alt="Play: João is taller than Maria and Pedro."
                    className={styles.page266__icon}
            ...
            <div className={styles.page266__comparisonBlock}>
              ...
              <div className={styles.page266__exampleBox}>
                <p>
                  • Anne is <span className={styles.page266__translation}>the</span> short<span className={styles.page266__translation}>est</span> of the group.
                  <img
                    src={eng_audio_icon}
                    alt="Play: Anne is the shortest of the group."
                    className={styles.page266__icon}
            ...
            <div className={styles.page266__comparisonBlock}>
              <div className={styles.page266__blockHeader}>
                <span className={styles.page266__colorSubTitle}>
                  4 - Superlativo (de <strong>superioridade</strong>): <strong>o/a mais <span className={styles.page266__sublinharSubTitle}>adjetivo</span></strong>
                </span>
              </div>
              <div className={styles.page266__exampleBox}>
                <p>
                  • Brenda is <span className={styles.page266__translation}>the </span>tall<span className={styles.page266__translation}>est</span> of them all.
                  <img
                    src={eng_audio_icon}
                    alt="Play: Brenda is the tallest of them all."
                    className={styles.page266__icon}
