    ...
    <div>
      <div className={styles['page106__container']}>
        ...
        <main className={styles['page106__main']}>
          <div>
            {/* Cabeçalho da seção com ícone branco à ESQUERDA */}
            <div
            ...
            {/* Tabela 1: exemplo com ícones SOMENTE no conteúdo (frase/tradução) */}
                ...
                {[
                  {
                    subject: 'I',
                    verb: 'work',
                    complement: 'on Mondays',
                    audio: pg106_audio1,
                    translation: 'Eu trabalho às segundas-feiras',
                    tradAudio: pg106_trad1,
                  },
                ].map((row, index) => (
                  <tr key={index}>
            ...
            {/* Tabela 2: sem ícones no cabeçalho (mantém onClick), apenas inputs */}
            <table className={styles['page106__styled--table']}>
              <colgroup>
                <col className={styles['page106__sujeito']} />
                <col className={styles['page106__verbo--auxiliar']} />
        ...
        {/* Notes com CAMPANHA (tocando áudio bell) */}
