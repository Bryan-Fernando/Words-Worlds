            ...
            <div className={styles["page86__container"]}>
                ...
                <main className={styles["page86__main"]}>
                    <div className={styles["page86__table-images-container"]}>
                        <div className={styles.pg86tabelaAfirmativaContainer}>
                            <div className={styles.pg86tableHeaderAfirmativa}>AFIRMATIVA</div>
                            <table className={styles.pg86styledTableAfirmativa}>
                                <thead className={styles.pg86Thead}>
                                    <tr className={styles.pg86celulatable}>
                                        <th>Introdução</th>
                                        <th>Sujeito</th>
