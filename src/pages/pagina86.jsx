  ...
  return (
    <div className={styles['page86__container']}>
      <header className={styles['page86__header']}>
        <h1 className={styles['page86__header--title']}>
          Grammar
          <img
            src={eng_audio_icon}
            alt="English Audio"
            className={styles['page86__icon']}
            onClick={() => playAudio('global_grammar')}
          />
        </h1>
        <div>
          <h2 className={styles['page86__header--subtitle']}>
          ...
          <p className={styles['page86__description']}>
            O artigo definido <span style={{ color: '#A61C28' }}>“THE / the“</span> é usado antes de substantivos cuja
            tradução pode ser <span style={{ color: '#A61C28' }}> “o - a - os - as“.</span>
          </p>
        </div>
      </header>
          ...
          <div className={styles['page86__images--container']}>
            <div className={styles['page86__images--row']}>
              <div className={styles['page86__image-item']}>
                ...
                <p className={styles['page86__text--red']}>
