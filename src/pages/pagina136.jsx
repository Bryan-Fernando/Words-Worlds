    ...
    <div>
      <div className={styles['page107__container']}>
        <header className={styles['page107__header']}>
          ...
          {/* Main verbs + áudio (apresentação incrementada) */}
        ...
        <main className={styles['page107__main']}>
          <div>
            ...
            {/* Tabela — ícones SOMENTE no conteúdo */}
                ...
                {[
                  {
                    ...
                    verb: 'work',
                    obj: 'on weekdays',
                    trad: 'Nós não trabalhamos em dias úteis',
                    audio: pg107_audio5,
                    tradAudio: pg107_trad5,
                  },
                  {
                    subject: 'You',
                    aux: "don't",
                    ...
                    verb: 'work',
                    obj: 'hard',
                    trad: 'Você não trabalha duro',
                    audio: pg107_audio6,
                    tradAudio: pg107_trad6,
                  },
                  {
                    subject: 'They',
                    aux: 'don’t',
                    ...
                    verb: 'work',
                    obj: 'on weekends',
                    trad: 'Eles não trabalham nos fins de semana',
                    audio: pg107_audio7,
                    tradAudio: pg107_trad7,
                  },
                ].map((row, index) => (
                  <tr key={index}>
            ...
            {/* Tabela de entrada — cabeçalhos só com onClick + pointer */}
            <table className={styles['page107__styled--table']}>
              <colgroup>
                <col className={styles['page107__subject']} />
                <col className={styles['page107__auxiliary--verb']} />
