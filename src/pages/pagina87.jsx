    ...
    return (
        <div className={styles["page87__container"]}>
            ...
            <main className={styles["page87__main"]}>
                <div className={styles.pg87tabelaAfirmativaContainer}>
                    <div className={styles.pg87tableHeaderAfirmativa}>AFIRMATIVA</div>
                    <table className={styles.pg87styledTableAfirmativa}>
                        <thead className={styles.pg87Thead}>
                            <tr className={styles.pg87celulatable}>
                                <th>Introdução</th>
                                <th>Sujeito</th>
