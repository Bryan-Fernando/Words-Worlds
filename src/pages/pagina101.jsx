...
const Pagina101 = () => {
  ...
  // Answers Key (C = afirmativa, D = negativa)
  const answersKeyItems = [
    ...
    { label: 'C.10', text: 'is' },
    // D) 1–10
    { label: 'D.1', text: 'am not' },
    { label: 'D.2', text: 'is not' },
    { label: 'D.3', text: 'are not' },
    { label: 'D.4', text: 'are not' },
    { label: 'D.5', text: 'is not' },
    { label: 'D.6', text: 'is not' },
    { label: 'D.7', text: 'is not' },
    { label: 'D.8', text: 'is not' },
    { label: 'D.9', text: 'are not' },
    { label: 'D.10', text: 'is not' },
  ];
  ...
  return (
    <div className={styles['page101__container']}>
      <main className={styles['page101__main']}>
        ...
        <div className={styles['page101__actions']}>
          <button className={styles['page101__check-button']} onClick={handleCheckClick}>
            <em>Check</em>
          </button>

          <button className={styles['page101__reset--button']} onClick={handleReset}>
            <em>Reset</em>
          </button>

          <button
            className={styles['page101__answersKey--button']}
        ...
        {showAnswersKey && (
          <div className={styles['page101__answersKey-box']}>
            {answersKeyItems.map((item, idx) => (
              <div key={idx} className={styles['page101__answersKey-item']}>
                <div className={styles['page101__answersKey-num']}>{item.label}</div>
                <div className={styles['page101__answersKey-text']}>{item.text}</div>
              </div>
            ))}
          </div>
        )}
